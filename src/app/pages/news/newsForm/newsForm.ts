...
export class NewsForm implements OnInit, OnChanges {
  ...
  handleSubmit($event) {
    ...
    this.form.value.relevantFrom = new Date(this.form.value.relevantFrom).toISOString()
    this.form.value.relevantTo = new Date(this.form.value.relevantTo).toISOString()
    ...
    this.form.value.showOnHome = this.form.value.showOnHome ? this.form.value.showOnHome : false;
    this.form.value.homePageDescription = this.form.value.homePageDescription ? this.form.value.homePageDescription : "";
    this.onSubmit.emit({
      ...this.form.value
    });
  }
  ...
  paste() {
    if (localStorage.getItem('newsformdata')) {
      ...
      this.form.controls.showOnHome.setValue(data.showOnHome);
      this.form.controls.homePageDescription.setValue(data.homePageDescription);
